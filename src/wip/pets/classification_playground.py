...
from src.classes.deep_learning.ConvNextWrapper import ConvNextWrapper
...
def main():
    ...
    train = torch.utils.data.DataLoader(OxfordIIITPetDataset(train=True, augment=False),
                                        batch_size=train_config["batch_size"],
                                        shuffle=True,
                                        num_workers=train_config["workers"],
                                        drop_last=True)
    test = torch.utils.data.DataLoader(OxfordIIITPetDataset(train=False),
                                       batch_size=train_config["batch_size"],
                                       shuffle=True,
                                       num_workers=train_config["workers"],
                                       drop_last=True)
